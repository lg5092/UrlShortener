    ...
    async lookupCredentials(awsAccountId, mode) {
        ...
        for (const source of this.host.credentialProviderSources) {
            ...
            try {
                ...
                (0, logging_1.warning)(`Uncaught exception in ${source.name}: ${(0, format_error_1.formatErrorMessage)(e)}`);
                available = false;
            }
            if (!available) {
