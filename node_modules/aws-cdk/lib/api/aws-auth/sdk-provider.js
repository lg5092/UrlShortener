    ...
    async defaultAccount() {
        return (0, cached_1.cached)(this, CACHED_ACCOUNT, async () => {
            try {
                ...
                (0, logging_1.debug)(`Unable to determine the default AWS account (${e.name}): ${(0, format_error_1.formatErrorMessage)(e)}`);
                return undefined;
            }
        });
    }
